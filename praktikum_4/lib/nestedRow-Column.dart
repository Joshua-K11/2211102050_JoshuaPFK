...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Food',
      home: buildHomePage('Joshua - 2211102050'),
    );
  }
  ...
  Widget buildHomePage(String title) {
    ...
    const subTitle = Text(
      'Pecel Lele adalah hidangan khas Indonesia yang terdiri dari ikan lele goreng yang disajikan dengan sambal pedas dan lalapan seperti timun, kol, serta kemangi.',
    ...
    final mainImage = Image.asset('Gambar/lele.jpeg', fit: BoxFit.cover);
